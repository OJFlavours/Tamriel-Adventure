...
# --- UTILITY FUNCTIONS ---
def get_npc_context(role, race, disposition, tags):
    """
    ...
    context = {
        "npc": {
            ...
            "attitude": tags.get("npc", {}).get("attitude", "neutral"),
        },
    }
    return context
...
# --- PURPOSE GENERATION ---
def generate_purpose(role, race, disposition, tags) -> str:
...
# --- CUSTOM TEMPLATES ---
def generate_dialogue_from_template(role, race, disposition, tags, template):
    """
