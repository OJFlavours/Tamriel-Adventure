...
def generate_location_appropriate_quest(player_level: int, location_tags: List[str], quest_giver_id: str | None = None, rumor_text: str | None = None) -> Quest | None:
    possible_templates = []
...
def generate_rumor(player_level: int, current_location: Dict[str, Any], quest_giver_id: str | None = None) -> Dict[str, Any]:
    ...
    """
    # Generate a potential quest using the function already in quests.py
